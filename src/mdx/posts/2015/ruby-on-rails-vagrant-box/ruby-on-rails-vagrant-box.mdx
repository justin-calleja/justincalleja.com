...
dateCreated: Dec 26, 2015 14:00:00 GMT+0000
...
To get around this, you _could_ stay port forwarding the ports you're interested in (say, 8080 on the host maps to 3000 on the guest), but that gets annoying really quickly if you later need to open other ports. I'll opt for putting the two on the same private network.
