...
tocEnabled: true
tags: ['godot']
dateCreated: Nov 13, 2021 14:00:00 GMT+0000
excerpt: 'Making flippable cards in Godot'
coverImage: club10-textures.png
---
...
<Image path="/card-scene.png" alt="The card scene" />

Next, for the `AnimationPlayer`:

<Image path="/card-animation-setup.png" alt="Card animation setup" />
...
<Image path="/club10-textures.png" alt="Textures for Club 10 card" />
...
<Image path="/button-in-tmp-scene.png" alt="Button in tmp scene" />
