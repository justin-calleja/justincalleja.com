...
tocEnabled: true
tags: ['godot']
dateCreated: Nov 25, 2021 14:00:00 GMT+0000
...
<Image path="/getting-started.png" alt="Getting started" />
...
<Image
  path="/pressed-signal.png"
  alt="Mapping the pressed signal to a function"
/>
...
<Image
  path="/world-env-changes.png"
  alt="Changes made to the WorldEnvironment settings"
/>
